...
import { Send, Image as ImageIcon, Mic, Square, Play, Pause, Download, FileText } from 'lucide-react';
...
export function Chat({ messages, onSendMessage }: ChatProps) {
  ...
  return (
    <div className="flex-1 lg:flex-none flex flex-col h-auto lg:h-full bg-[#0F172A] lg:border-l border-t lg:border-t-0 border-[#1F2937] lg:w-[320px] xl:w-[320px] min-h-0 shadow-2xl">
      <div className="flex-shrink-0 p-4 border-b border-[#1F2937] bg-[#11141A]">
        ...
        {messages.map((msg) => {
          ...
          return (
            <div key={msg.id} className={`flex flex-col ${isSystem ? 'items-center py-2' : ''}`}>
              {isSystem ? (
                <span className="text-[9px] text-[#475569] uppercase tracking-widest px-2 bg-[#0F172A] text-center font-display">
                  {msg.text}
                </span>
              ) : (
                <div className="flex gap-2 w-full">
                  ...
                  <div className="flex flex-col flex-1 min-w-0">
                    ...
                    {msg.type === 'text' && (
                      <p 
                        className="text-sm text-[#CBD5E1] bg-[#1E293B] p-2 rounded-r-lg rounded-bl-lg border-l-2 break-words" 
                    ...
                    {msg.type === 'voice' && msg.mediaUrl && (
                      <div className="mt-1 bg-[#1E293B] p-2 rounded-r-lg rounded-bl-lg border-l-2" style={{ borderColor: msg.color }}>
                    ...
                    {msg.type === 'file' && msg.mediaUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-1 flex items-center gap-2 bg-[#1E293B] hover:bg-[#263449] p-2 rounded-r-lg rounded-bl-lg border-l-2 text-[#CBD5E1] transition-colors"
                        style={{ borderColor: msg.color }}
                      >
      ...
      <div className="flex-shrink-0 p-3 bg-[#11141A] border-t border-[#1F2937] safe-area-bottom relative">
        <form onSubmit={handleSubmit} className="relative flex items-center gap-2">
          {showUrlInput ? (
             <div className="flex-1 min-w-0 flex items-center bg-[#1E293B] border border-[#3B82F6] rounded-full px-2 py-1 transition-all">
                <input
                   type="text"
                   value={mediaUrlInput}
             ...
             <input
              ...
              className="flex-1 min-w-0 bg-[#1E293B] border border-[#334155] rounded-full py-2 pl-4 pr-4 text-sm focus:outline-none focus:border-[#3B82F6] transition-colors text-[#CBD5E1] placeholder-[#475569]"
              autoComplete="off"
            />
          )}
          ...
          {!showUrlInput && (
             <>
               ...
               <button
                  ...
                  className="p-2 text-[#94A3B8] hover:text-[#3B82F6] transition-colors bg-[#1E293B] rounded-full border border-[#334155]"
               ...
               <button
                  ...
                  className="hidden sm:flex px-2 py-1 text-[9px] uppercase font-bold items-center justify-center text-zinc-400 hover:text-blue-400 bg-[#1E293B] rounded-lg border border-[#334155] transition-colors shrink-0"
               ...
               {isRecording ? (
                  ...
                  <button
                     ...
                     className="p-2 text-[#94A3B8] hover:text-[#3B82F6] transition-colors bg-[#1E293B] rounded-full border border-[#334155] shrink-0"
    ...
    <div className="w-full max-w-[220px]">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div
            className="h-2 rounded-full bg-[#0F172A] cursor-pointer overflow-hidden"
            onClick={handleSeek}
          >
            <div
